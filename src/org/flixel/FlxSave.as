	...
	public class FlxSave extends Object
	{
		...
		public function bind(Name:String):Boolean
		{
			...
			catch(e:Error)
			{
				...
				trace("ERROR: There was a problem binding to\nthe shared object data from FlxSave.");
				destroy();
				return false;
			}
		...
		protected function onDone(Result:uint):Boolean
		{
			...
			{
				case PENDING:
					trace("FLIXEL: FlxSave is requesting extra storage space.");
					break;
				case ERROR:
					trace("ERROR: There was a problem flushing\nthe shared object data from FlxSave.");
					break;
				default:
					break;
			}
		...
		protected function checkBinding():Boolean
		{
			...
			{
				trace("FLIXEL: You must call FlxSave.bind()\nbefore you can read or write data.");
				return false;
			}
			return true;
		}
